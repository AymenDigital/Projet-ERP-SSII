...
public class AdditionalFeeServiceImpl implements AdditionalFeeService {
    ...
    @Override
    public AdditionalFeeDtoResponse<Number> CreateAdditionalFee(AdditionalFeeDtoRequest additionalFeeDtoRequest) {
        ...
        return modelMapper.map(AdditionalFeeSaved, AdditionalFeeDtoResponse.class);     }
